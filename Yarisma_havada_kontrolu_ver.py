...
font=1.5
yazi=input("Lutfen bir kelime giriniz: ")
takeoff=5
sayac=0
...
konum_array=[[iha.location.global_relative_frame.lat,iha.location.global_relative_frame.lon,iha.location.global_relative_frame.alt,0]]
